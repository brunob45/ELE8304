...
// Generated on: Dec 11 2018 01:00:09 EST (Dec 11 2018 06:00:09 UTC)
...
module rv_adder(in_a, in_b, in_sign, in_sub, out_sum);
  ...
  wire n_191, n_192, n_194;
  XNOR2X1 g2561__7837(.A (n_34), .B (n_194), .Y (out_sum[32]));
  XNOR2X1 g2562__7557(.A (n_192), .B (n_1), .Y (n_194));
  CLKXOR2X1 g2564__7654(.A (n_191), .B (n_190), .Y (out_sum[31]));
  AOI22XL g2563__8867(.A0 (n_191), .A1 (n_190), .B0 (in_a[31]), .B1
       (n_35), .Y (n_192));
  ...
  CLKXOR2X1 g2658__7547(.A (n_35), .B (in_a[31]), .Y (n_191));
